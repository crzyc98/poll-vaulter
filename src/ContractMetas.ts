...
export const Contracts: { [chainId in ChainIdKey]?: ContractMeta[] } = {
    ...
    [ChainId.FANTOM]: [
        ...
        { label: 'yvYFI', address: '0x6d6029557a06961aCC5F81e1ffF5A474C54e32Fd', abi: Erc20QiStablecoin__factory.abi },
        {
            ...
            abi: CrosschainQiStablecoinwbtc__factory.abi,
            decimals: 1e8,
        },
    ...
    [ChainId.AVALANCHE]: [
        ...
        {
            label: 'Stake DAO USD Strategy Vault',
            address: '0x13a7fe3ab741ea6301db8b164290be711f546a73',
            abi: CrosschainQiStablecoinV2__factory.abi,
        },
        { label: 'WETH', address: '0xa9122dacf3fccf1aae6b8ddd1f75b6267e5cbbb8', abi: CrosschainQiStablecoinSlim__factory.abi },
        {
            ...
            abi: CrosschainQiStablecoinSlimV2__factory.abi,
            decimals: 1e8,
        },
